...
void debugLog(const char* str1,uint_64 value, uint_8 color = BACKGROUND_BLINKINGWHITE | FOREGROUND_BLACK){

	PrintString(str1);
	PrintString(IntegerToString(value));
	PrintString("\n\r");
